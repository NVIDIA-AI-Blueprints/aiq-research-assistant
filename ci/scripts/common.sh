...
export PY_ROOT="${PROJECT_ROOT}/aira"
export PROJ_TOML="${PROJECT_ROOT}/aira/pyproject.toml"
export PY_DIRS="${PY_ROOT} ${PROJECT_ROOT}/ci/scripts "
...
export CI_MERGE_REQUEST_TARGET_BRANCH_NAME=${CI_MERGE_REQUEST_TARGET_BRANCH_NAME:-"trunk"}
